...
function RightBar() {
    ...
    const fetchWhatsHappeningData = async () => {
        const Data = await fetch(
            "http://localhost:10000/api.twitter.com/users/update/3"
        )
    ...
    return (
        <div className="rightBar" title="rightBar">
            <div className="input">
                <SearchOutlinedIcon className="search_icon" />
                <input placeholder="search Twitter" type="text" title="input"/>
            </div>
            <div className="container">
                <h2>What's Happening</h2>
                <ul className="content" title="content">
                ...
                <a id="show-more-btn" href="#" title="show-more">
                    Show more
                </a>
            </div>
        </div>
